...
<TreeBrowser
  collections={{
    1: {
      ...
      name: "Grade 1",
      collections: [2],
      renderAfterItems: <TreeBrowser.Node variant="indent"><Button>All Grade 1 outcomes</Button></TreeBrowser.Node>
    },
    2: {
      id: 2,
      name: "Math Outcomes",
      ...
      renderBeforeCollections: <TreeBrowser.Node variant="indent"><Spinner renderTitle={'Loading..'} size="small"/></TreeBrowser.Node>
    }
  }}
  items={{
    1: { id: 1, name: "Can add" },
